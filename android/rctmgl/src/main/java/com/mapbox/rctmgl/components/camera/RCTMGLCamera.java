...
public class RCTMGLCamera extends AbstractMapFeature {
    ...
    private LocationManager.OnUserLocationChange mLocationChangeListener = new LocationManager.OnUserLocationChange() {
        ...
        if (getTrackasiaMap() == null || mLocationComponentManager == null || !mLocationComponentManager.hasLocationComponent() || (!mFollowUserLocation)) {
            return;
        }
    ...
    private void updateUserLocationSignificantly(boolean isAnimated) {
        ...
        if (zoom < 0) {
            double camerZoom = mMapView.getTrackasiaMap().getCameraPosition().zoom;
    ...
    private void enableLocation() {
        ...
        mMapView.getTrackasiaMap().getStyle(new Style.OnStyleLoaded() {
            @Override
    ...
    public void setUserTrackingMode(int userTrackingMode) {
        ...
        if (getTrackasiaMap() != null) {
            updateLocationLayer(getTrackasiaMap().getStyle());
        }
    }
    ...
    TrackasiaMap getTrackasiaMap() {
        ...
        return mMapView.getTrackasiaMap();
    }

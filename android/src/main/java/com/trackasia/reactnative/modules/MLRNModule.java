...
import com.trackasia.reactnative.http.CustomHeadersInterceptor;
...
public class MLRNModule extends ReactContextBaseJavaModule {
    ...
    public static final String DEFAULT_STYLE_URL = "https://maps.track-asia.com/styles/v1/streets.json?key=public_key";
     ...
     * @see https://github.com/track-asia/trackasia-react-native/issues/25#issuecomment-1382382044
     */
    @Deprecated
    @ReactMethod
        ...
        mReactContext.runOnUiQueueThread(new Runnable() {
            ...
            public void run() {
                if (accessToken == null) {
                    ...
                    TrackAsia.getInstance(getReactApplicationContext(), accessToken, WellKnownTileServer.Mapbox);
                }
            }
        });
    }
    ...
    private void initializeTrackAsiaInstance() {
        mReactContext.runOnUiQueueThread(new Runnable() {
            @Override
            public void run() {
                TrackAsia.getInstance(getReactApplicationContext());
